      ...
      <Container>
        ...
        <div>
          ...
          <div className='grid grid-cols-3 gap-2 p-4'>
            <Button className={`h-24 flex flex-col items-center justify-start p-1  ${isFocused ? 'bg-red-400' : ''}}  `} onClick={()=>setIsFocused(!isFocused)}>
               <CreditCard />
                  <p>Transfer via <br /> card number</p>
                  
              
            </Button>
            <Button className={`h-24 flex flex-col items-center justify-start p-1  ${isFocused ? 'bg-red-400' : ''}}  `} onClick={()=>setIsFocused(!isFocused)}>
               <User />
                  <p>Transfer your <br /> bank</p>
                  
              
            </Button>
            <Button className={`h-24 flex flex-col items-center justify-start p-1  ${isFocused ? 'bg-red-400' : ''}}  `} onClick={()=>setIsFocused(!isFocused)}>
               <CreditCard />
                  <p>Transfer to <br /> aby bank</p>
